...
module CsPersistentHashMapDnc30 =
  open Persistent.Dnc30.CS
...
module FsPersistentHashMapDnc20 =
  open Persistent.Dnc20
...
module FsPersistentHashMapDnc30 =
...
//        400000
  ...
  let testCases =
    [|
      "Persistent Hash Map (C# DNC 3.0)"  , CsPersistentHashMapDnc30.createTestCases
      "Persistent Hash Map (F# DNC 2.0)"  , FsPersistentHashMapDnc20.createTestCases
      "Persistent Hash Map (F# DNC 3.0)"  , FsPersistentHashMapDnc30.createTestCases
  ...
  do
    ...
    for name, creator in testCases do
      printfn "  Warming up test case %A" name
